...
for(const f of fs.readdirSync('content/projects')){const p='content/projects/'+f;let text=fs.readFileSync(p,'utf8');for(const [a,b]of Object.entries(replacements))text=text.replaceAll(a,b);fs.writeFileSync(p,text);}
